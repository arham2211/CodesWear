...
const Hoodies = ({ products }) => {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <Head>
        <title>Hoodies Collection - CodesWear</title>
        <meta
          name="description"
          content="Shop premium coding-themed hoodies at CodesWear.com - Wear the code"
        />
        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-600">
              Stay cozy and stylish with our high-quality hoodies. Perfect for coding sessions and casual outings.
            </p>
          </div>
                      ...
                      <div className="p-5 flex flex-col justify-between flex-grow">
                        <div>
                          ...
                          <p className="text-gray-600 mb-3 text-sm line-clamp-2">
                            High-quality fabric with a comfortable fit for coding marathons and chilly evenings.
                          </p>
                        </div>
