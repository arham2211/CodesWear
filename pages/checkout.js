...
//               id="name"
//               name="name"
//               className="w-full bg-white rounded border border-gray-300 focus:border-[#6366f1] focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
//             />
//           </div>
//         </div>
...
//       <div className="rounded bg-indigo-200 p-6 my-4">
//         <ol className="list-decimal font-semibold">
//           {Object.keys(cart).length === 0 && (
//             <div className="my-4 font-normal text-center">
//               Your cart is Empty!
//             </div>
//           )}
...
//           ))}
//         </ol>
//         <span className="total font-semibold underline">
//           Subtotal: ${subTotal}
//         </span>
//       </div>
//       <Link href="/checkout" onClick={initiatePayment}>
//         <button
//           disabled={disabled}
//           className="disabled:bg-gray-400 flex mt-1 text-white bg-[#6366f1] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
//         >
                    ...
                    {Object.keys(cart).map((k) => (
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-16 h-16 bg-indigo-100 rounded-md flex items-center justify-center text-indigo-600">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-8 w-8"
                              fill="none"
